...
export type ControlsUIConfiguration = {
    ...
    backToDashboardButtonType?: UIElementConfig;
...
export class Controls {
    ...
    backToDashboardIcon: BackToDashboardIcon;
    xrIcon: XRIcon;
    ...
    constructor(config?: ControlsUIConfiguration) {
        ...
        if (!config || shouldCreateButton(config.backToDashboardButtonType)) {
            this.backToDashboardIcon = new BackToDashboardIcon();
        }
    ...
    public get rootElement(): HTMLElement {
        if (!this._rootElement) {
            ...
            if (!!this.backToDashboardIcon) {
                this._rootElement.appendChild(
                    this.backToDashboardIcon.rootElement
                );
            }
            if (!!this.statsIcon) {

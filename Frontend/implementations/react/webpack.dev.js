...
module.exports = merge(common, {
    ...
    plugins: [
        new webpack.DefinePlugin({
            ...
            'process.env.client_id_cog': JSON.stringify('7njlcmm9073t0ugu180hjcbctt'),
            ...
            'process.env.client_secret_cog': JSON.stringify('bck6hge73b9n1clso8af02k45irsv24jk6fvn625m1dvga4g1cm'),
            // Refer cloudformation output : Callback URL for Cognito (CognitoCallBackURL)
            'process.env.callback_uri_cog': JSON.stringify('https://d1xm7vtc5cw951.cloudfront.net'),
            // Refer cloudformation output : Web socket endpoint for api server (APIGatewayWSAPI)
            'process.env.api_ws': JSON.stringify('wss://x9xvvvgsmh.execute-api.ap-southeast-1.amazonaws.com/production?tokenId=abcd'),
            // Refer cloudformation output : Web socket endpoint for signalling server (SignallingServerWSAPI)
            'process.env.sig_ws': JSON.stringify('wss://signalling-1345965209.ap-southeast-1.elb.amazonaws.com?'),

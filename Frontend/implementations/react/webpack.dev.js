...
module.exports = merge(common, {
    ...
    plugins: [
        new webpack.DefinePlugin({
            ...
            'process.env.client_id_cog': JSON.stringify('15q1h3ajpn0844pk1oavulhbn5'),
            ...
            'process.env.client_secret_cog': JSON.stringify('5iqahvvnsp7ne3ahi6qe4ep489pon22edd38bu8vuf96n71mv63'),
            // Refer cloudformation output : Callback URL for Cognito (CognitoCallBackURL)
            'process.env.callback_uri_cog': JSON.stringify('https://d3jbl00fj2ypla.cloudfront.net'),
            // Refer cloudformation output : Web socket endpoint for api server (APIGatewayWSAPI)
            'process.env.api_ws': JSON.stringify('wss://8l0so5ewzg.execute-api.ap-southeast-1.amazonaws.com/production?tokenId=abcd'),
            // Refer cloudformation output : Web socket endpoint for signalling server (SignallingServerWSAPI)
            'process.env.sig_ws': JSON.stringify('wss://signalling-966232278.ap-southeast-1.elb.amazonaws.com?'),
